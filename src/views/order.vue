<template>
    <div class="order">
        ...
        <header class="pay">
    <span class="payIcon">
        <svg @click="cmdAlert" class="icon" height="200" p-id="1883" t="1574730873035"
             version="1.1" viewBox="0 0 1024 1024" width="200" xmlns="http://www.w3.org/2000/svg"><path
                d="M225.62 485.97l575.1 346.2-0.04 68.75-575.04-345.6-0.02-69.35z" fill="#707070" p-id="1884"></path><path
                d="M225.62 485.97L800.7 129.01l0 69.52-575.06 356.79-0.02-69.35z" fill="#707070"
                p-id="1885"></path>
        </svg>
    </span>
            <span>订单详情</span>
        ...
        <div class="orderInfo">
            <p class="p-title">订单号：<span>051911260309</span></p>
            <p class="p-text">日本冲绳4晚5天百变自由行【那覇市中心/购物美食两不误/酒店随心加价升级】(国航航班 3小时直达 市区3星酒店 超低起价 +149/人预订专车接送机)</p>
        </div>
        <div class="order-info-detail"><p class="p-detail"><b>2019-12-08</b><span>出发</span> <b>1</b><span>成人</span>
            <b>0</b><span>儿童</span></p></div>
        <section class="ay-section contact-info">
            <div class="section-title">联系人信息</div>
            <div class="section-group">
                <div class="form-item">
                    <div class="form-item-title">姓名</div>
                    <div class="form-item-inner"><input class="form-input" placeholder="请填写联系人姓名" v-model="userName"></div>
                </div>
                <div class="form-item">
                    <div class="form-item-title">手机</div>
                    <div class="form-item-inner"><input class="form-input" placeholder="请填写联系人手机" v-model="userPhone"></div>
                </div>
                <div class="form-item">
                    <div class="form-item-title">邮箱</div>
                    <div class="form-item-inner"><input class="form-input" placeholder="请填写联系人邮箱" v-model="email"></div>
                </div>
            </div>
        </section>
<!--        <section class="ay-section traveller-info">-->
<!--            <div class="section-title">出行人信息</div>-->
<!--            <div class="section-group fix-top-boder">-->
<!--                <div class="form-item">-->
<!--                    <div class="form-item-title">出行人1</div>-->
<!--                    <div class="form-item-inner with-arrow">-->
<!--                        <div class="form-value" style="display: none;"><p class="inner-title"> /</p>-->
<!--                            <p class="inner-desc"></p></div>-->
<!--                        <div class="form-item-inner"><input class="form-input" placeholder="请提供出行人信息" type="text"></div>-->
<!--                        <svg @click="alertCard" class="icon" height="200" p-id="5043" t="1574739789863" version="1.1"-->
...
<!--            </div>-->
<!--        </section>-->
        <section class="ay-section contract-info">
            <div class="contract-inner">
                <div class="contract-title">米途出行合同<span>未签约</span> <em style="display: none;">已签约</em>
                </div>
                <div class="contract-brief"><p>旅行社业务经营许可证编号：MT-00000</p>
                </div>
            </div>
        </section>
        <div class="footer-wrap">
            <div class="footer-bar">
                <div class="footer-item ay-center-v">
                    <div><p class="footer-price"><span>待付</span><em>¥4399</em> <a href="javascript:void(0);">明细</a></p>
                    </div>
                </div>
                <div class="footer-item ay-center-v">
                    <div class="service-tel"><a name="hometel"><i class="icon-service"></i>
                        ...
                        <p>客服电话</p></a></div>
                    <button class="ay_btn ay_btn_disabled ay_btn_primary" @click="sumbit"> 提交订单</button>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            alertCard() {
                this.$router.push('/contactCard');
            },
            sumbit(){
                let a=/^.+$/;
                let b=/^1[35789]\d{9}$/;
                let c=/^\w+[@]\w+\.com$/;
                if(a.test(this.userName)&&b.test(this.userPhone)&&c.test(this.email)){
                // this.$router.go(1)
                }else{
                    Dialog.alert({
                        message: '您的信息填写有误，请正确填写，谢谢'
                    }).then(() => {
                        // on close
                    });
                }
...
<style scoped>
    ...
    .booking-wrap-content .form-item {
        position: relative;
        display: -ms-flexbox;
        display: flex;
    ...
    .form-input {
        ...
        height: 20px;
        border: none;
        font-family: Heiti SC, Helvetica Neue, Helvetica, Roboto, sans-serif;
        font-size: 17px;
        color: #333;
        line-height: 20px;
 ...
 .ay-center-v {
    ...
    .footer-bar .footer-item p span {
        font-size: 12px;
        color: #999;
        font-weight: 300;
    }

    .footer-bar .footer-item p em {
        font-style: normal;
        font-size: 24px;
        color: #ff5523;
        line-height: 30px;
    ...
    .footer-bar button.ay_btn, .footer-bar input.ay_btn {
        margin: 0;
        padding: 0;
        width: 100px;
        height: 45px;
